...
createPickle(training_data1,224,"400")
training_data2 = create_training_data(224,"C:/Users/Vandana/Desktop/cmpe 257/Project/Project/data/potholes_dataset_manisha/train")
training_data3 = create_training_data(224,"C:/Users/Vandana/Desktop/cmpe 257/Project/Project/data/pothole_data_tejal/train")
training_data =training_data1
training_data.extend(training_data2)
createPickle(training_data,224,"800")
training_data.extend(training_data3)
createPickle(training_data,224,"1000")
